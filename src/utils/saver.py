...
def save_checkpoint(items, step, model_dir, ignore=None, keep_every_n=10000000):
    if ignore is None:
        ignore = []
...
class Saver(object):
    ...
    def restore(self, model_dir, map_location=None, step=None, item_keys=None):
